...
```text
classes.xsl              69852  37.29%
to-java.xsl              64825  34.60%
set-locators.xsl         13160  7.03%
set-original-names.xsl   8741   4.67%
attrs.xsl                8171   4.36%
data.xsl                 7091   3.79%
package.xsl              5205   2.78%
anonymous-to-nested.xsl  5166   2.76%
tests.xsl                5118   2.73%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-04-09 at 17:56,
on Linux with 4 CPUs.
The total is 187329 milliseconds.
...
[benchmark-gha]: https://github.com/volodya-lombrozo/eo/actions/runs/24204958026
