...
```text
to-java.xsl              75684  38.17%
classes.xsl              56016  28.25%
set-locators.xsl         17447  8.80%
set-original-names.xsl   11443  5.77%
attrs.xsl                10013  5.05%
data.xsl                 8808   4.44%
package.xsl              6392   3.22%
anonymous-to-nested.xsl  6382   3.22%
tests.xsl                6101   3.08%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-14 at 14:01,
on Linux with 4 CPUs.
The total is 198286 milliseconds.
...
[benchmark-gha]: https://github.com/volodya-lombrozo/eo/actions/runs/20996480411
